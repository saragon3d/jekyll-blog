...
You can find the source code for the Jekyll new theme at: {% include icon-github.html username="jekyll" %} / [tufte-jekyll](https://github.com/saragon3d/tufte-jekyll)
